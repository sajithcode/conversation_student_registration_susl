...
//        return redirect('http://employability-study.sociologicalnotes.com/');
        ...
        if($request->faculty=="Graduate Studies" || $request->faculty=="Indigenous Knowledge & Community Studies" || $request->faculty=="Agricultural Sciences" || $request->faculty=="Management Studies" || $request->faculty=="Social Sciences & Languages" || $request->faculty=="Medicine"){
            try {
                $pro->save();
        ...
        }elseif ($SurveyDocumentsCount>0 && $rGDocumentsCount==0 && $request->faculty!="Graduate Studies" && $request->faculty!="Indigenous Knowledge & Community Studies" && $request->faculty!="Agricultural Sciences" && $request->faculty!="Management Studies" && $request->faculty!="Social Sciences & Languages" && $request->faculty!="Medicine"){
            try {
                $pro->save();
            }catch (QueryException $e){
                return redirect()->route('eligibleStd')
